...
public class QueryParamCountryTests extends QueryParamBaseTest
{
	
	public static final String PARAMTESTDATA_COUNTRY = "countryData.json";
	
	@Test
	public void test_queryParam_country_valid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
		
		QueryParamSearchData rawData = getTestData(PARAMTESTDATA_COUNTRY);
	...
	@Test
	public void test_queryParam_country_invalid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
