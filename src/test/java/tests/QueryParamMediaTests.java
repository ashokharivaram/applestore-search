...
public class QueryParamMediaTests extends QueryParamBaseTest
{
	
	public static final String PARAMTESTDATA_MEDIA = "mediaData.json";
	
	@Test
	public void test_queryParam_media_valid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
		
		QueryParamSearchData rawData = getTestData(PARAMTESTDATA_MEDIA);
	...
	@Test
	public void test_queryParam_media_invalid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
