...
public class QueryParamAttributeTests extends QueryParamBaseTest
{
	
	public static final String PARAMTESTDATA_ATTRIBUTE = "attributeData.json";
	
	@Test
	public void test_queryParam_attribute_valid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
		
		QueryParamSearchData rawData = getTestData(PARAMTESTDATA_ATTRIBUTE);
	...
	@Test
	public void test_queryParam_attribute_invalid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
