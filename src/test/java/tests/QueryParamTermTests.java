...
public class QueryParamTermTests extends QueryParamBaseTest
{
	
	public static final String PARAMTESTDATA_TERM = "termData.json";
	
	@Test
	public void test_queryParam_term_valid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
		
		QueryParamSearchData rawData = getTestData(PARAMTESTDATA_TERM);
	...
	@Test
	public void test_queryParam_term_invalid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
