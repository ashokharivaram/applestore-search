...
public class QueryParamVersionTests extends QueryParamBaseTest
{
	
	public static final String PARAMTESTDATA_VERSION = "versionData.json";
	
	@Test
	public void test_queryParam_version_valid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
		
		QueryParamSearchData rawData = getTestData(PARAMTESTDATA_VERSION);
	...
	@Test
	public void test_queryParam_version_invalid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
