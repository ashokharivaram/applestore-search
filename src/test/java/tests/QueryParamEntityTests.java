...
public class QueryParamEntityTests extends QueryParamBaseTest
{
	
	public static final String PARAMTESTDATA_ENTITY = "entityData.json";
	
	@Test
	public void test_queryParam_entity_valid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
		
		QueryParamSearchData rawData = getTestData(PARAMTESTDATA_ENTITY);
	...
	@Test
	public void test_queryParam_entity_invalid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
