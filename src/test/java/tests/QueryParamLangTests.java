...
public class QueryParamLangTests extends QueryParamBaseTest
{
	
	public static final String PARAMTESTDATA_LANG = "langData.json";
	
	@Test
	public void test_queryParam_lang_valid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
		
		QueryParamSearchData rawData = getTestData(PARAMTESTDATA_LANG);
	...
	@Test
	public void test_queryParam_lang_invalid() throws Exception
	{
		SoftAssert softAssert = new SoftAssert();
